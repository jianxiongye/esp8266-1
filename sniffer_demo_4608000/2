...
{		//os_printf("system_get_cpu_freq=%d |\n",system_get_cpu_freq());
		...
		wifi_fpm_set_sleep_type(0);
    uart_init(4608000, 4608000);
//uart_init(BIT_RATE_921600,BIT_RATE_921600);
    os_printf("\r\n\r\nSDK version:%s\n", system_get_sdk_version());
    
    sniffer_init();
			os_printf("!!!!wifi_get_user_limit_rate_mask=%d wifi_fpm_get_sleep_type=%d\r\n",wifi_get_user_limit_rate_mask() , wifi_fpm_get_sleep_type());
