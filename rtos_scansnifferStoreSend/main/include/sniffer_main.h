...
#define  SNIFFER_MIN_TIME    (10) //sniffer 时间，当到达后将关闭混杂模式即关闭sniffer 
...
#define  SNIFFER_DATA_LEN    56   // 组织sniffer 探测数据的长度
...
//extern char nvsData[OVERFLOW * SNIFFER_DATA_LEN];
